...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container" data-aos="fade-in">
      <h1>Welcome to Minion <br>Online Maid & Driver Hiring Platform</h1>
      <h2>
        Hire Local Helpers & Workers across Bangladesh
      </h2>
  ...
  <main id="main">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-4 col-lg-5" data-aos="fade-up">
            <div class="content">
              <h3>Why Choose Minion for your household works?</h3>
              <p>
    ...
    <!-- ======= About Section ======= -->
    <section id="about" class="about section-bg pt-0">
      <div class="container">
        <div class="row">
          <!-- <div
              ...
              data-aos="fade-right"
            >
              <img src="images/driver1.jpg" alt="about_us" class="img-thumbnail">
            </div> -->

          <div class="col-xl-12 col-lg-12 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            <h1 data-aos="fade-up" class="section-title">About us</h1>
            <p class="text-justify" data-aos="fade-up">
              Minion enables millions of underprivileged and unorganized blue-collar workforce in finding local
              employment, free of cost, directly from the nearby employers, and without the middlemen in between.

              In turn, Minion ends up organizing the industry for millions of Households, Small Business Owners and
              Corporates. In a way which makes it easier, quicker, reliable & cost-effective for the employers to find &
              hire nearby Blue-collar Workers, again without the middlemen in between.

              With a larger vision to end poverty, forced labour, worker's exploitation, and human trafficking, Minion
              is working towards creating an ecosystem of inclusive economic growth for the underprivileged unorganised
              workforce of India.

              The platform uses complex algorithms via its different digital platforms as a medium to establish a direct
              Employer-Worker connect.

              Minion also works closely with the Government bodies and a few NGOs towards improving the lives of the
              Blue-collar workforce of Bangladesh.
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-xl-3 col-lg-4 mt-4" data-aos="fade-up" data-aos-delay="200">
            <div class="info-box">
              ...
              <h3>Call Us</h3>
              <p>+88 017 123 456 789<br />+88 016 123 456 789</p>
            </div>
          </div>
        </div>

...
<html lang="en">
  ...
  <a class="btn btn-outline-info" href="workersignin.php" role="button" style="margin-top: 20px; margin-bottom: 20px; margin-left: 46%;">Worker Sign In</a>
	 <?php require_once 'processworkerlogin.php'; ?>
    <div class="row justify-content-center">
        <form action="processworkerlogin.php" method="POST"> <!-- connect with processworkerlogin.php -->
		<!-- taking informations -->

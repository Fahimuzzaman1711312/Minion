...
<head>
 ...
 <!-- ======= Header ======= -->
  ...
  <body>
  <a class="btn btn-outline-info" href="myworkers.php" role="button" style="margin-top: 20px; margin-bottom: 20px; margin-left: 50%;">My Workers</a>
  <div class="container">
    ...
    <?php 
      ...
      $sql = "SELECT * FROM `contract`, worker WHERE userid='$userid' and contract.workerid = worker.workerid";// geting values from database
    ...
    <?php 
      if(isset($_POST['reviewbtn'])){
        ...
        $sql = "INSERT INTO `workerreview`(`userid`, `workerid`, `review`) VALUES ('$userid','$workerid','$review')";// geting values from database
	...
	//print workers
      while($row = $result->fetch_assoc()):?>
        ...
        <form action="" method="POST" role="form">
          ...
          <td>
                ...
                <button type="submit" class="btn btn-primary btn-lg active" role="button" style="margin:20px 0px;" name="endjobbtn" value="<?php echo $row['workerid'];?>">End Job</button>
      ...
      <a href="user.php" class="btn btn-warning btn-lg active" role="button" style="margin:20px 0px;" aria-pressed="true">Go Back</a>    
    </div>
    </div>
    <?php

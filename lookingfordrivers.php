...
<div class="container" >
  <a class="btn btn-outline-info" href="lookingfordrivers.php" role="button" style="margin-top: 20px; margin-bottom: 20px; margin-left: 50%;">Drivers List</a></div>
      ...
      while($row = $result->fetch_assoc()):?>
        ...
        <form action="" method="POST" role="form">
          ...
          <td>
              ...
              <button type="submit" class="btn btn-primary btn-lg active" role="button" style="margin-top:20px" name="reviewbtn" value="<?php echo $row['workerid'];?>">See Review</button>
          </td>
          <td>
            
                <button type="submit" class="btn btn-primary btn-lg active" role="button" style="margin-top:20px" name="hirebtn" value="<?php echo $row['workerid'];?>">Hire</button>
